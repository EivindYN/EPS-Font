...
class TrainOptions(BaseOptions):
    ...
    def initialize(self, parser):
        ...
        parser.set_defaults(display_freq=1000, update_html_freq=1000, print_freq=1000, save_latest_freq=5000000, n_epochs=10, n_epochs_decay=10, display_ncols=10, save_epoch_freq=1)
        self.isTrain = True
        return parser
